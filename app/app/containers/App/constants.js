...
export const LOAD_CONFIG = 'env-impact-comparison/App/LOAD_CONFIG';
export const LOAD_CONFIG_SUCCESS = 'env-impact-comparison/App/LOAD_CONFIG_SUCCESS';
export const LOAD_CONFIG_ERROR = 'env-impact-comparison/App/LOAD_CONFIG_ERROR';
